...
plot( d, b$V3, ylab="Global Active Power (kilowatts)", xlab="", type="l")
plot(d, b$V5, ylab="Voltage", xlab="datetime", type="l")
...
plot(d, b$V4, ylab="Global_reactive_power", xlab="datetime", type="l")
